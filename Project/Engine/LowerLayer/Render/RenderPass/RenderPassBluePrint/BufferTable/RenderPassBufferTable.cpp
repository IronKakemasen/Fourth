...
//std::unique_ptr<Pass::RequiredBufferInfo> RenderPassBluePrint::BufferTable::BufferInfoTable(RenderPassComponent ::Pass pass_)
//{
//	std::unique_ptr<Pass::RequiredBufferInfo> info(new Pass::RequiredBufferInfo);
//
//	switch (pass_)
//	{
